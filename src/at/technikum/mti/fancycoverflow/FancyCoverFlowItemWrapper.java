...
class FancyCoverFlowItemWrapper extends ViewGroup {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		Log.i("FancyCoverFlowItem", "onLayout");
		if (changed) {
			...
			if (this.wrappedViewBitmap == null
				...
				this.wrappedViewDrawingCanvas.setDrawFilter(new PaintFlagsDrawFilter(0, 
	...
	private void createReflectedImages() {
        ...
        this.wrappedViewDrawingCanvas.setDrawFilter(new PaintFlagsDrawFilter(0, Paint.ANTI_ALIAS_FLAG  
                | Paint.FILTER_BITMAP_FLAG)); //设置图形、图片的抗锯齿。可用于线条等。按位或.  
	...
	public void  recycleWrappedViewBitmap(){
		if(this.wrappedViewBitmap!=null&&!this.wrappedViewBitmap.isRecycled()){
